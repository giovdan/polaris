namespace Mitrol.Framework.Domain.Interfaces
{
    ...
    public interface IReadOnlyPlaTorch : IReadOnlyUnit
    {
        int CurrentToolId { get; }
    ...
    public interface IReadOnlyOxyTorch : IReadOnlyUnit
    {
        int CurrentToolId { get; }
    ...
    public interface IReadOnlySaw: IReadOnlyUnit
    {
