namespace Mitrol.Framework.MachineManagement.Application.Services
{
    ...
    public class ExternalFileConfigurationManagement : MachineManagementBaseService
            , IAttributeDefinitionEnumManagement
    {
        ...
        public IEnumerable<AttributeSource> FindAttributeSourceValues()
        {
            ...
            var attributesInfo = DomainExtensions.GetEnumAttributes<AttributeDefinitionEnum, AttributeInfoAttribute>(AttributeDefinition);
