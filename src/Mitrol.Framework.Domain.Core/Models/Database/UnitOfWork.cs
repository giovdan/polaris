namespace Mitrol.Framework.Domain.Core.Models
{
    ...
    public class UnitOfWork : Disposable, IUnitOfWork<IDatabaseContext>
    {
        ...
        IDatabaseContext IUnitOfWork<IDatabaseContext>.Context { get; set; }
        ...
        void IUnitOfWork<IDatabaseContext>.Commit()
        {
